...
Config.define("game",   "uploadurl",    str,   "http://s0nicg34r.nazuka.net/fofcs/upload.php")
Config.define("game",   "leftymode",    bool,  False, text = _("Lefty mode"),           options = {False: _("No"), True: _("Yes")})
Config.define("game",	"showlyrics",	bool,  True,  text = _("Show lyrics"),          options = {False: _("No"), True: _("Yes")})
...
#Coffee Mod items
Config.define("coffee", "twoDkeys",            bool,  True,   text = _("2D Keys"),              options = {False: _("No"), True: _("Yes")})
Config.define("coffee", "twoDnote",            bool,  True,   text = _("2D Notes"),             options = {False: _("No"), True: _("Yes")})
Config.define("coffee", "theme",               int,   1,      text = _("Theme"),                options = {0: _("FoF"), 1: _("GHIII")})
Config.define("coffee", "hopoType",            int,   0,      text = _("HoPo Type"),            options = {0: _("White"), 1: _("Black"), 2: _("Dot")})
Config.define("coffee", "moreHopo",            int,   1,   text = _("HoPo"),                    options = {0: _("Less"), 1: _("Normal"), 2: _("More")})
Config.define("coffee", "speedStyle",          int,   0,      text = _("Board Speed Style"),           options = {0: _("Difficulty & BPM"), 1: _("Difficulty"), 2: _("BPM")})
option = []
for i in range(50,160,10):
  option.append(i)
Config.define("coffee", "neckSpeed",            int,  100,      text = _("Board Speed %"),        options = option)
...
class GameEngine(Engine):
  ...
  def __init__(self, config = None):
    ...
    if self.config.get("game", "uploadurl").startswith("http://s0nicg34r.nazuka.net/fretsweb/chart.php"):
      self.config.set("game", "uploadurl", "http://s0nicg34r.nazuka.net/fretsweb/upload.php")

...
class Data(object):
  ...
  def __init__(self, resource, svg):
    ...
    self.loadSvgDrawing(self, "star1",   "star1.png", textureSize = (128, 128))
    self.loadSvgDrawing(self, "star2",   "star2.png", textureSize = (128, 128))
    self.loadSvgDrawing(self, "left",    "left.png",  textureSize = (128, 128))
    self.loadSvgDrawing(self, "right",   "right.png", textureSize = (128, 128))
    self.loadSvgDrawing(self, "ball1",   "ball1.png", textureSize = (128, 128))
    self.loadSvgDrawing(self, "ball2",   "ball2.png", textureSize = (128, 128))

    # load misc images
    self.loadSvgDrawing(self, "loadingImage", "loading.png", textureSize = (256, 256))
    ...
    fontSize  = [22, 108]
    self.theme = Config.get("coffee", "theme")

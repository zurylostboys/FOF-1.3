...
class Credits(Layer, KeyListener):
  ...
  def __init__(self, engine, songName = None):
    ...
    credit_song = "Frets on Fire\\defy"
    ...
    self.engine.loadSvgDrawing(self, "background1", "editor.png")
    self.engine.loadSvgDrawing(self, "background2", "keyboard.png")
    self.engine.loadSvgDrawing(self, "background3", "cassette.png")
    ...
    self.credits = [
      ...
      space,
      Text(nf, ns, c1, "left",   _("Coffee Mod Programming:")),
      Text(nf, ns, c2, "right",  _("Ultimate Coffee")),
      space,
      Text(nf, ns, c1, "left",   _("Coffee Mod Graphics:")),
      Text(nf, ns, c2, "right",  _("Ultimate Coffee")),
      Text(nf, ns, c2, "right",  _("Racer 13")),
      Text(nf, ns, c2, "right",  _("TXF")),
      space,
      Text(nf, ns, c1, "left",   _("Coffee Mod Testing:")),
      Text(nf, ns, c2, "right",  _("RavenSourcious")),
      Text(nf, ns, c2, "right",  _("Racer 13")),
      Text(nf, ns, c2, "right",  _("All the good people")),
      Text(nf, ns, c2, "right",  _("at FretsOnFire.net")),
      space,

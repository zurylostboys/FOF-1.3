...
class SettingsMenu(Menu.Menu):
  def __init__(self, engine):
    ...
    gameSettings = [
      ...
      ConfigChoice(engine.config, "game",  "showlyrics", autoApply = True),
    ...
    coffeeSettings = [
      ConfigChoice(engine.config, "coffee", "twoDkeys", autoApply = True),
      ConfigChoice(engine.config, "coffee", "twoDnote", autoApply = True),
      ConfigChoice(engine.config, "coffee", "hopoType", autoApply = True),
      ConfigChoice(engine.config, "coffee", "moreHopo", autoApply = True),
      ConfigChoice(engine.config, "coffee", "theme",    autoApply = True),
      ConfigChoice(engine.config, "coffee", "speedStyle", autoApply = True),
      ConfigChoice(engine.config, "coffee", "neckSpeed", autoApply = True),
    ]
    coffeeSettingsMenu = Menu.Menu(engine, coffeeSettings + applyItem)
    ...
    settings = [
      ...
      (_("Coffee Settings"),   coffeeSettingsMenu),
    ]
